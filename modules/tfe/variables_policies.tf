...
variable "ip_pools" {
  ...
  * dns_servers_v4 - DNS Servers for the IP Pool.
  * from - host address of the pool starting address.
  * gateway - ip/prefix of the gateway.
  * organization - Name of the Intersight Organization to assign this pool to.  https://intersight.com/an/settings/organizations/
  * size - Number of host addresses to assign to the pool.
